    ...
    <div>
      ...
      <BrowserView>
        ...
        >
          {!props.seeall ? (
            <div style={{ marginBottom: "3vh" }}>
              <h3 style={{ fontWeight: 600, color: '#413131', marginTop: '20px', fontSize: 26 }}>{sectioninfo.name}</h3>
              <div
                style={{
                  flex: 1,
                  display: "flex",
              ...
              >
                <p style={{ margin: 0, color: '#413131' }}>{sectioninfo.description}</p>
              </div>
            </div>
          ) : null}
          ...
          >
            {sectioninfo.products.map((item, index) => {
              if (index <= 3) {
                return (
                  <div key={index} style={{ display: "flex", width: "600px", marginRight: '20px' }}>
                    <ItemSectionHome item={item} />
                  </div>
                );
              }
